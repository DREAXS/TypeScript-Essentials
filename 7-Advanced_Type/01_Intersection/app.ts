...
// BusinessPartner arayüzü, bir iş ortağının temel bilgilerini tanımlar.
interface BusinessPartner {
  name: string;
  credit: number;
}

// Identity arayüzü, kimlik bilgilerini tanımlar.
interface Identity {
  name: string;
  id: number;
}

// Contact arayüzü, iletişim bilgilerini tanımlar.
interface Contact {
  email: string;
  phone: string;
}

// Employee tipi, Identity ve Contact arayüzlerini birleştirir.
...
// Customer tipi, BusinessPartner ve Contact arayüzlerini birleştirir.
